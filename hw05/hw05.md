...
This is what the structure of the `gapminder` dataset looks like
    before:
...
![](hw05_files/figure-gfm/unnamed-chunk-17-1.png)<!-- -->
...
![](hw05_files/figure-gfm/unnamed-chunk-19-1.png)<!-- -->
