...
Let's look at barcharts of each continents population.
```{r}
gapminder %>% 
...
This is what the structure of the `gapminder` dataset looks like before:
...
Plotting the frequency box plot of our written-and-read `shuffled_gap` dataset looks like this.
